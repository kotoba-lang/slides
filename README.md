...
| Patch/update path | Brand-new comments part (a slide with no comments before this edit) | ❌ not implemented | needs a new part + new relationship + content-type overrides + possibly a brand-new `commentAuthors.xml` — a bigger lift than editing an already-existing comments part, left for later |
