...
| Table | Column widths / row heights | ❌ not implemented | always recomputes even division across `:slides/w`/`:slides/h`; an imported table with deliberately uneven source widths loses that on regen |
